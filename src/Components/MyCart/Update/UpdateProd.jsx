...
const UpdateProd = () => {
    ...
    const { _id, products_id, image, product_name, brand_name, types_of_products, rating, short_description, price
    } = updateProd;
    console.log(updateProd.product_name)
    ...
    return (
        <div className="bg-[#F4F3F0] p-24">
            <h2 className="text-3xl font-extrabold text-center">Update Coffee: {product_name}</h2>
                ...
                <div className="md:flex mb-8">
                    <div className="form-control md:w-1/2">
                        ...
                        <label className="input-group">
                            <input type="text" name="product" defaultValue={product_name} placeholder="Category" className="input input-bordered w-full" />
                        </label>
                    </div>
                    <div className="form-control md:w-1/2 ml-4">
                        ...
                        <label className="input-group">
                            <input type="text" name="brand" defaultValue={brand_name} placeholder="Details" className="input input-bordered w-full" />
                        </label>
                    </div>
                </div>
                ...
                <div className="md:flex mb-8">
                    ...
                    <div className="form-control md:w-1/2 ml-4">
                        ...
                        <label className="input-group">
                            ...
                            <textarea className="input input-bordered w-full" placeholder="Details"
